...
def main(caption_path,vocab_path,threshold):
    ...
    for split in splits:
        folder = '/root/volume/coco2014/%s2014' %split
        resized_folder = '/root/volume/coco2014/%s2014_resized/' %split
...
caption_path = '/root/volume/coco2014/kor_annotations/captions_kor_train.json'
vocab_path = '/root/volume/coco2014/kor_vocab.pkl'
threshold = 5
