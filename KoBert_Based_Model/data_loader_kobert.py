...
def get_loader(method, vocab, batch_size):
    ...
    if method == 'train':
        root = '/root/volume/coco2014/train2014_resized'
        json = '/root/volume/coco2014/kor_annotations/captions_kor_train.json'
    elif method =='val':
        root = '/root/volume/coco2014/val2014_resized'
        json = '/root/volume/coco2014/kor_annotations/captions_kor_validation.json'
